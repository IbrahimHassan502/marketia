...
$(function () { 'use strict';
               ...
               $('.cleint .owl-carousel .owl-item.active:first .item .cleintname:last-child').addClass('active');
               ...
               var e = 0;
                $(window).scroll(function() {
                    var countr = $('#counter');
                  var oTop = $(countr).offset().top - window.innerHeight + $(countr).outerHeight();
               ...
               var o = 0
                $(window).scroll(function () {
                    var cont_ul = $('.contact ul'),
                        ulanim = $(cont_ul).offset().top - window.innerHeight + $(cont_ul).outerHeight() ;
              ...
              function swiprit() {
                      ...
                      if (!$(slide).is(':first-child')) {
                       ...
                       $('.slider .slideholder').css('z-index', 1).removeClass('active', 'slideout');
                ...
                function handleGesure() {
                    if (touchendX < touchstartX) {swiplft();}
                    if (touchendX > touchstartX) {swiprit();}
                                        }
               ...
               $(window).on("scroll", function () {
                    if($(this).scrollTop() >= 500) {$(".scrolltop2").addClass('active'); }
                    else {$(".scrolltop2").removeClass('active');}
                });
